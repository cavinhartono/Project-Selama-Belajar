...
public class App {
  public static void main(String[] args) {
    ...
    // Tanpa menggunakan Library 
    String afterSubstringAndConcatText = (a.substring(1, 4) + c);
    String d = obj.delete(afterSubstringAndConcatText, 1, 3);

    // Menggunakan Library
    StringBuilder dWithStringBuilder = new StringBuilder(afterSubstringAndConcatText).delete(1, 3);

    System.out.println("1. '" + x + "'");
    System.out.println("2. " + y + " (dihitung tanpa tanda kutip)");
    System.out.println("3. '" + z + "' (tanpa library)");
    System.out.println("   '" + zWithStringBuilder + "' (dengan library)");
    System.out.println("4. '" + c + "'");
    System.out.println("   '" + cWithStringBuilder + "' (dengan library)");
    System.out.println("5. '" + d + "'");
    System.out.println("   '" + dWithStringBuilder + "' (dengan library)");
  }
}